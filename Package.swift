...
let package = Package(
    ...
    dependencies: [
        ...
        .Package(url: "https://github.com/bytethenoodle/json.git", majorVersion: 2),

        // A type safe routing package including HTTP and TypeSafe routers.
        .Package(url: "https://github.com/bytethenoodle/routing.git", majorVersion: 2),

        // Parses `Content-Type: multipart` as defined in RFC 2046.
        .Package(url: "https://github.com/bytethenoodle/multipart.git", majorVersion: 2),

        // Swift implementation of the BCrypt password hashing function
        .Package(url: "https://github.com/bytethenoodle/bcrypt.git", majorVersion: 1),
    ],
    exclude: [
        "Sources/Development",
        "Sources/Performance",
